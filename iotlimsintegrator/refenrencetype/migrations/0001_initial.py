...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RefValues',
            fields=[
                ('ref_value_id', models.AutoField(primary_key=True, serialize=False, verbose_name='IOT_Device_Id')),
                ...
                ('reftype_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='refenrencetype.referencetype', verbose_name='Reference Type')),
            ],
            options={
