    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_rule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eventmanagement.event_rule', verbose_name='Event Rule Id')),
                ('param_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='masterdata.param', verbose_name='Parameter ID')),
